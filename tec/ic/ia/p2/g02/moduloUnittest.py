...
class TestUM(unittest.TestCase):
    ...
    def test_buscar_dos_puntos_mayor_rendimiento(self):
            print("__________________________________________________________________\n")
            print("Test : buscar_dos_puntos_mayor_rendimiento(Lista)")
            entrada = ["aaq: Pawanobskewi",	"rel:etymological_origin_of",	"eng: Penobscot"]
            resultado = ["aaq","Pawanobskewi",	"rel","etymological_origin_of",	"eng","Penobscot"]
            self.assertEqual(buscar_dos_puntos_mayor_rendimiento(entrada),resultado)
    ...
    def test_padre(self):
        ...
        self.assertEqual(pyDatalog.ask(entrada),resultado)
    # -----------------------------------------------------------------------
    ################################### 3 ##################################
    """
    ...
    def test_ancestro(self):
        ...
        resultado = {('hijo de hermano de Freyser',), ('hijo de Freyser',), ('hermano de Freyser',), ('Freyser',)}
        self.assertEqual(pyDatalog.ask(entrada),resultado)
    ...
    """
    # -----------------------------------------------------------------------
    def test_listar_palabras_comunes(self):
        print("__________________________________________________________________\n")
    ...
    """
    # -----------------------------------------------------------------------
    def test_obtener_Lista_Porcentajes(self):
        print("__________________________________________________________________\n")
        print("Test : obtener_Lista_Porcentajes(idioma,lenguajes) .")
        entrada = "idioma_y"
        resultado = ['idioma_x', 1]
        self.assertEqual(obtener_Lista_Porcentajes(entrada,lenguajes1)[0],resultado)  
    ################################### 15 ##################################
    """
    ...
    """
    # -----------------------------------------------------------------------
    def test_obtener_Mayor_Porcentaje(self):
        print("__________________________________________________________________\n")
        print("Test : obtener_Mayor_Porcentaje(idioma,lenguajes) .")
        entrada = "idioma_y"
        resultado = "idioma_x 100.0"
        self.assertEqual(obtener_Mayor_Porcentaje(entrada,lenguajes1),resultado)
    ################################### 16 ##################################
    """
    ...
    def test_leer(self):
        ...
        entrada = "prueba.tsv"
        resultado = [[['aaq', 'senabe', 'rel', 'etymology', 'eng', 'sannup']], [['abs', 'beta', 'rel', 'variant:orthography', 'zsm', 'beta']], [], [], [['abe', 'waniigan', 'rel', 'is_derived_from', 'eng', 'wannigan']], [['abe', 'waniigan', 'rel', 'has_derived_form', 'eng', 'wangan']], [['aaq', 'Pawanobskewi', 'rel', 'etymological_origin_of', 'eng', 'Penobscot']], []]
        self.assertEqual(leer(entrada),resultado)
    ################################### 17 ##################################
    """
    ...
    """
    # -----------------------------------------------------------------------
    def test_cargarPadres(self):
        print("__________________________________________________________________\n")
        print("Test : cargarPadres(relaciones, datos) .")
        entrada1 = leer("prueba.tsv")
        entrada2 = ["etymological_origin_of","variant:orthography"]
        cargarPadres(entrada2, entrada1)
        print(pyDatalog.ask('padre(X,Y)'))
        resultado = {('hermano de Freyser', 'Papa de Freyser'), ('hermano de Minor', 'Papa de Minor'), ('Fer', 'Papa de Fer'), ('Minor', 'Papa de Minor'), ('Freyser', 'Papa de Freyser'), ('Penobscot', 'Pawanobskewi'), ('hijo de hermano de Freyser', 'hermano de Freyser'), ('hijo de Freyser', 'Freyser'), ('hermano de Fer', 'Papa de Fer'), ('beta', 'beta')}
        self.assertEqual(pyDatalog.ask('padre(X,Y)'),resultado)
    ################################### 18 ##################################
    """
    ...
    """
    # -----------------------------------------------------------------------
    def test_cargar_Idiomas1(self):
        print("__________________________________________________________________\n")
        print("Test : cargar_Idiomas1(relaciones, datos,valor) .")
        entrada1 = leer("prueba.tsv")
        entrada2 = ["etymological_origin_of","variant:orthography"]
        cargar_Idiomas1(entrada2, entrada1,2)
        resultado = {('hijo de Freyser', 'idioma_y'), ('Penobscot', 'eng'), ('beta', 'zsm'), ('Fer', 'idioma_x'), ('Papa de Freyser', 'idioma_x'), ('Fer', 'idioma_y'), ('Freyser', 'idioma_y')}
        self.assertEqual(pyDatalog.ask('idioma(X,Y)'),resultado)
    ################################### 19 ##################################
    """
