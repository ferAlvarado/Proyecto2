...
def func_relacion_hermana():
    lbl_pal1_her["text"]=palabra1.get()
    lbl_pal2_her["text"]=palabra2.get()
    palabra1.delete(0, END)
    palabra2.delete(0, END)
    lbl_res_hermanas["text"]=" " #En esta se pone el resultado de la búsqueda V/F
    ventana_detalles()
def func_relacion_hija():
    lbl_pal1_hija["text"]=palabra1.get()
    lbl_pal2_hija["text"]=palabra2.get()
    palabra1.delete(0, END)
    palabra2.delete(0, END)
    lbl_res_hija["text"]=" " #En esta se pone el resultado de la búsqueda V/F
    ventana_detalles()
def func_relacion_tia():
    lbl_pal1_tia["text"]=palabra1.get()
    lbl_pal2_tia["text"]=palabra2.get()
    palabra1.delete(0, END)
    palabra2.delete(0, END)
    lbl_res_tia["text"]=" " #En esta se pone el resultado de la búsqueda V/F
    ventana_detalles()
...
def func_palabra_idioma():
    ...
    if (cmbox_idioma_pal.get()=="Relacionadas"):
        ...
        lbl_res_relacionado["text"]=" " #Resultado SI/NO
...
def func_idiomas():
    ...
    if (cmbox_idioma.get()=="Contar palabras en común"):
        ...
        lbl_res_cantPal.place(x=400,y=250)
        lbl_res_cantPal.config(font=("Helvetica", 30))
        lbl_res_cantPal["text"]=" " #Idioma y porcentaje
    else:
        palabra1.delete(0, END)
        palabra2.delete(0, END)
        palabra=palabra1.get()
